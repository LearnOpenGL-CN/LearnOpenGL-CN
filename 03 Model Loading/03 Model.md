本文作者JoeyDeVries，由[Django](http://bullteacher.com/)翻译自[http://learnopengl.com](http://learnopengl.com/)
...
loadMaterialTextures函数遍历所有给定纹理类型的纹理位置，获取纹理的文件位置，然后加载生成纹理，把信息储存到Vertex结构体。看起来像这样：
